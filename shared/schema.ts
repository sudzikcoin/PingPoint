...
export const brokers = pgTable("brokers", {
  ...
  co2FactorGramPerMile: decimal("co2_factor_gram_per_mile", { precision: 10, scale: 2 }).notNull().default("1610"),
...
export const trackingPings = pgTable("tracking_pings", {
  ...
  // IOSiX ELD telemetry — all nullable; populated when driver's phone is connected to the ELD
  rpm: integer("rpm"),
  engineLoadPct: decimal("engine_load_pct", { precision: 5, scale: 2 }),
  coolantTempC: decimal("coolant_temp_c", { precision: 5, scale: 1 }),
  oilPressureKpa: decimal("oil_pressure_kpa", { precision: 6, scale: 1 }),
  fuelRateGph: decimal("fuel_rate_gph", { precision: 6, scale: 3 }),
  totalFuelGal: decimal("total_fuel_gal", { precision: 10, scale: 2 }),
  engineHours: decimal("engine_hours", { precision: 10, scale: 1 }),
  throttlePct: decimal("throttle_pct", { precision: 5, scale: 2 }),
  batteryVoltage: decimal("battery_voltage", { precision: 4, scale: 2 }),
  odometerMiles: decimal("odometer_miles", { precision: 10, scale: 1 }),
  tripMiles: decimal("trip_miles", { precision: 8, scale: 1 }),
  currentGear: integer("current_gear"),
  dpfSootPct: decimal("dpf_soot_pct", { precision: 5, scale: 2 }),
  defLevelPct: decimal("def_level_pct", { precision: 5, scale: 2 }),
  activeDtcCount: integer("active_dtc_count"),
